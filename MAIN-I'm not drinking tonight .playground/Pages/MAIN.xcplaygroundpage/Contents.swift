...
//  let Butt4 = UIButton()
    ...
    ("You have just come home after a stessful day,  you want to relax on the bed, but the usual call comes from your friend asking you to go out tonight.",1,1,2),
    ("First hard choice \n \n N°1) Stay home \n N°2) Go out with your friends.",3,4,2),
    ("You' ll really wish to go out with your friends tonight, but because of your job, at the end, you have decided to stay home.",3,3,0),
    ("You have decided to go out with your friends and also if you know that tomorrow you will go to work. So you promise to yourself to come back home early tonight.",4,4,5),
